...
public class General : object, IEquatable<General>, ISerializable
{
    ...
    // Попытка присвоения ссылки
    public virtual bool TryAssignReference<TTarget>(out TTarget target) where TTarget : General
    {
        target = this as TTarget;
